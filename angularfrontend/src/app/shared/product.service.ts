...
//   listProductsUrl: string = 'http://localhost:8081/api/product/allProducts';
//   listProduct: string = 'http://localhost:8081/api/product';
//   createProductUrl: string = 'http://localhost:8081/api/product'
//   getProductUrl: string = 'http://localhost:8081/api/product'
//   updateProductUrl: string = 'http://localhost:8081/api/product';
//   products: string = 'http://localhost:8081/api/product/products';
//   deleteProductUrl: string = 'http://localhost:8081/api/product/delete';
...
export class ProductService {
  ...
  getProducts(categoryId: number): Observable<any> {
    return this.http.get(`${this.listProduct}/${categoryId}/listProducts`);
  }
  ...
  createProduct( categoryId: number , product: FormData): Observable<any> {
    return this.http.post<Product>(`${this.createProductUrl}/${categoryId}/save` , product );
  }

  getProduct(id: number , categoryId: number): Observable<any> {
    return this.http.get(`${this.getProductUrl}/${categoryId}/product/${id}`);
  }

  updateProduct(categoryId: number , id: number , product: FormData): Observable<any> {
    return this.http.put(`${this.updateProductUrl}/${categoryId}/update/${id}` , product);
  }
