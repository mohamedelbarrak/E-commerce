...
import com.youtube.jwt.criteria.ProductCriteriaRepository;
...
import com.youtube.jwt.repository.PromotionRepository;
...
public class ProductServiceImp implements ProductService {
 ...
 //       Promotion maybePromotion = promotionRepository.findById(promotionId).orElseThrow(() -> {throw new RuntimeException("this product is not found");});
